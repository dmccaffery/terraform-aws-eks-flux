...
| sso | SSO secrets this cluster owns (null unless sso.enabled): the generated dex client secrets and the composed config<br/>documents. The out-of-band dex-<id>-<field> connector containers live in modules/secrets (a durable root), fed the<br/>same sso value. |
